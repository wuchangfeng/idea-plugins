...
public class GenerateSingletonDialog extends JDialog {
    ...
    private JLabel generateSingletonCodeLabel;


    public GenerateSingletonDialog() {
...
// add your code here if necessary
    ...
    public static void main(String[] args) {
        GenerateSingletonDialog dialog = new GenerateSingletonDialog();
        dialog.pack();
